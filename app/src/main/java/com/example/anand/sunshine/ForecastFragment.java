...
/**
 * Created by Anand on 29/12/2014.
 */
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]>
    {
        ...
        protected String[] doInBackground(String... params)
        {
            ...
            try {
                ...
                //Trinidad and Tobago URL
                //URL url = new URL("http://api.openweathermap.org/data/2.5/forecast?lat=10.67&lon=-61.52&mode=json&units=metric&cnt=7");
                //URL url = new URL("http://api.openweathermap.org/data/2.5/forecast/daily?q=94043&mode=json&units=metric&cnt=7");
                final String FORECAST_BASE_URL = "http://api.openweathermap.org/data/2.5/forecast?";
                //final String QUERY_PARAM = "q";
                final String LAT_PARAM = "10.67";
                final String LONG_PARAM = "-61.52";
                final String FORMAT_PARAM = "mode";
                final String UNITS_PARAM = "units";
                final String DAYS_PARAM = "cnt";

                Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                        .appendQueryParameter(latitude, LAT_PARAM)
                        .appendQueryParameter(longitude, LONG_PARAM)
...
*/
    ...
    private String[] getWeatherDataFromJson(String forecastJsonStr, int numDays)
        ...
        System.out.println("In getWeatherDataFromJson method");
        ...
        for(int i = 0; i < 7; i++)
        {
            ...
            System.out.println("weather Array : " + dayForecast.toString());
            ...
            System.out.println("Day value: " + day.toString());
            ...
            System.out.println("Temp value : " + temperatureObject.toString());
            double temp = temperatureObject.getDouble("temp");
